...
exports.inquireEasypaisa = inquireEasypaisa;
exports.inquireJazzCash = inquireJazzCash;
...
const EASYPAISA_INQUIRY_CONFIG = {
    ...
    apiUrl: process.env.EASYPAISA_INQUIRY_API_URL ||
        'https://easypay.easypaisa.com.pk/easypay-service/rest/v4/inquire-transaction',
};
async function inquireEasypaisa(orderId) {
    if (!orderId) {
    ...
    const response = await axios_1.default.post(EASYPAISA_INQUIRY_CONFIG.apiUrl, payload, {
        headers: {
...
const JAZZCASH_INQUIRY_CONFIG = {
    ...
    salt: process.env.JAZZCASH_INTEGRITY_SALT ||
        ...
        'e4989022y8',
    apiUrl: process.env.JAZZCASH_INQUIRY_API_URL ||
        'https://onlinepayments.jazzcash.com.pk/payment-orchestrator/api/v2/rest/payments/status/inquiry',
};
function generateJazzCashInquirySecureHash(payload) {
...
async function inquireJazzCash(txnRefNo) {
    if (!txnRefNo) {
    ...
    const response = await axios_1.default.post(JAZZCASH_INQUIRY_CONFIG.apiUrl, body, {
